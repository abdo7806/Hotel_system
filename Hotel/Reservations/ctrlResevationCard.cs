...
{
    public partial class ctrlResevationCard : UserControl
    {
        ...
        public ctrlResevationCard()
        {
            InitializeComponent();
        }

        public void LoadReservationInfo(int ReservationID)// نعرض بيانات الشخص على حسب رقمة الوطني
        {
        ...
        private void ctrlResevationCard_Load(object sender, EventArgs e)
        {
